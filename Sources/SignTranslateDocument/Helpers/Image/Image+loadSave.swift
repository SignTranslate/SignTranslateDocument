...
extension UIImage{
    public static func saveImageURL(_ url: URL, key:String = "savedImageUrls") {
    ...
    public static func getSavedImageURLs(key:String = "savedImageUrls") -> [URL] {
        let key = "savedImageURLs"
        return UserDefaults.standard.array(forKey: key) as? [URL] ?? []
    }

    public static func loadImages(from urls: [URL]) -> [UIImage] {
